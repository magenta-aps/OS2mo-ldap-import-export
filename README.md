...
* For MO classes: A link to the employee or organization unit's uuid must be present.
...
uuid attribute links to a [global](#filters-and-globals) called `employee_uuid`.
