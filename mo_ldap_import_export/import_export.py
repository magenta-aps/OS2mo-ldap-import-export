...
class SyncTool:
    ...
    async def import_single_user(
        ...
        if employee_uuid:
            ...
            ldap_to_mo_mapping = self.settings.conversion_mapping.ldap_to_mo
            create_employee = False
            if (
                ldap_to_mo_mapping
                and "Employee" in ldap_to_mo_mapping
                and ldap_to_mo_mapping["Employee"].import_to_mo_as_bool(manual_import)
            ):
        ...
        # TODO: Why do we always want Employee?
