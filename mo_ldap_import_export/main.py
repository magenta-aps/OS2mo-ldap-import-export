...
from mo_ldap_import_export.cloudevents import assert_event_type
from mo_ldap_import_export.cloudevents import event2uuid
...
@mo2ldap_router.post(
    "/org_unit",
    dependencies=[
        Depends(assert_event_type({"dk.magenta.rammearkitektur.os2mo.org_unit"}))
    ],
)
@http_reject_on_failure
async def http_process_org_unit(
    sync_tool: depends.SyncTool,
    object_uuid: Annotated[UUID, Depends(event2uuid)],
) -> None:
