...
async def test_refresh_people_by_org_unit(
    dataloader: AsyncMock, sync_tool: SyncTool, graphql_mock: GraphQLMocker
) -> None:
    ...
    route = graphql_mock.query("org_unit_engagement_people_refresh")
    route.result = {"employee_refresh": {"objects": []}}
