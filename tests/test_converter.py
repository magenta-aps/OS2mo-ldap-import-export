...
from mo_ldap_import_export.autogenerated_graphql_client.read_itsystem_user_key import (
...
async def test_get_it_system_user_key(converter: LdapConverter):
    ...
    converter.dataloader.graphql_client.read_itsystem_user_key.return_value = (  # type: ignore
        parse_obj_as(
            ReadItsystemUserKeyItsystems, {"objects": [{"current": {"user_key": "AD"}}]}
        )
    )
    ...
    converter.dataloader.graphql_client.read_itsystem_user_key.return_value = (  # type: ignore
        parse_obj_as(
            ReadItsystemUserKeyItsystems,
            {"objects": [{"current": {"user_key": "Office365"}}]},
        )
    )
