...
def graphql_mock(dataloader, respx_mock) -> Iterator[GraphQLMocker]:
    ...
    # Python attempt at downcasting the existing object
    graphql_mocker.__dict__ = respx_mock.__dict__
    yield graphql_mocker
...
async def test_load_mo_facet_uuid(dataloader: DataLoader, graphql_mock: GraphQLMocker):
    ...
    route.result = {"facets": {"objects": [{"uuid": str(uuid)}]}}
